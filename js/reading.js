...
function shareTabReading(tabId, title) {
  ...
  content.innerHTML = `
    ...
    <div class="share-social-grid">
      <a class="share-social-btn share-facebook" href="https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}&quote=${encodedOneLiner}" target="_blank" rel="noopener" onclick="autoCopyShare()">
